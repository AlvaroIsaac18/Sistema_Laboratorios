                ...
                <div class="accordion sidebar-accordion" id="accordionUsuarios">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingUsuarios">
                            <button class="accordion-button <?php echo (in_array($activeRoute, ['gestionUsuarios', 'rolesPermisos'])) ? '' : 'collapsed'; ?>" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseUsuarios" aria-expanded="<?php echo (in_array($activeRoute, ['gestionUsuarios', 'rolesPermisos'])) ? 'true' : 'false'; ?>" aria-controls="collapseUsuarios">
                                <i class="bi bi-people me-2"></i> Usuarios
                            </button>
                        </h2>
                        <div id="collapseUsuarios" class="accordion-collapse collapse <?php echo (in_array($activeRoute, ['gestionUsuarios', 'rolesPermisos'])) ? 'show' : ''; ?>" aria-labelledby="headingUsuarios"
                            ...
                            <div class="accordion-body p-0">
                                ...
                                <a href="#" class="nav-link py-2 ps-5 small">Roles y Permisos</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion sidebar-accordion" id="accordionHorarios">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingHorarios">
                            <button class="accordion-button <?php echo (in_array($activeRoute, ['horarios'])) ? '' : 'collapsed'; ?>" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseHorarios" aria-expanded="<?php echo (in_array($activeRoute, ['horarios'])) ? 'true' : 'false'; ?>" aria-controls="collapseHorarios">
                                <i class="bi bi-calendar3 me-2"></i> Horarios
                            </button>
                        </h2>
                        <div id="collapseHorarios" class="accordion-collapse collapse <?php echo (in_array($activeRoute, ['horarios'])) ? 'show' : ''; ?>" aria-labelledby="headingHorarios"
                            ...
                            <div class="accordion-body p-0">
                                ...
                                <a href="#" class="nav-link py-2 ps-5 small">Conflictos y Soluciones</a>
                            </div>
                        </div>
                    </div>
                </div>
